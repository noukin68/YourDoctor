...
--
-- Host: 127.0.0.1    Database: yourdoctor
-- ------------------------------------------------------
...
CREATE TABLE `prescriptionmedications` (
  ...
  KEY `CustomerID` (`CustomerID`),
  CONSTRAINT `prescriptionmedications_ibfk_1` FOREIGN KEY (`CustomerID`) REFERENCES `customers` (`CustomerID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `products` VALUES (1,'Терафлю','Терафлю от гриппа и простуды порошок для приготовления раствора - это комбинированное лекарственное средство, действие которого обусловлено входящими в его состав компонентами, оказывает жаропонижающее, анальгезирующее, сосудосуживающее действие, устраняет симптомы \"простуды\".',600.00,100);
...
CREATE TABLE `supply` (
  ...
  KEY `ProductID` (`ProductID`),
  CONSTRAINT `supply_ibfk_1` FOREIGN KEY (`SupplierID`) REFERENCES `suppliers` (`SupplierID`),
  CONSTRAINT `supply_ibfk_2` FOREIGN KEY (`ProductID`) REFERENCES `products` (`ProductID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'ad','1122'),(2,'er','1122');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'yourdoctor'
--

--
-- Dumping routines for database 'yourdoctor'
--
...
-- Dump completed on 2023-11-02 18:55:37
